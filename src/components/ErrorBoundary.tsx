...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    (error as { __ErrorBoundary?: boolean }).__ErrorBoundary = true;
    (window as { __COMPONENT_ERROR__?: (error: Error, errorInfo: React.ErrorInfo) => void }).__COMPONENT_ERROR__?.(error, errorInfo);
